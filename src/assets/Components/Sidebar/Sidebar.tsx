...
function Sidebar({setIsShowMenuPanel} : Props) {
  ...
  return (
    <>
      <div className="dark:bg-[#151b27] flex border-l-2 border-solid  dark:border-sky-200 rounded-l-xl flex-col gap-5 3xs:gap-10  bg-slate-200 w-[300px] pr-4 pl-4 pt-4">
        <div className="flex gap-1 relative items-center justify-between border-b-1 dark:pb-5 dark:rounded-2xl border-b-slate-400 pb-4 border-solid">
          ...
          >
            <svg className="w-6 h-6 bg-amber-600 text-white">
              <use href="#x-mark"></use>
            </svg>
          </div>
        </div>
