...
function Sidebar({setIsShowMenuPanel} : Props) {
  ...
  return (
    <>
      <div className="dark:bg-[#151b27] flex border-l-2 border-solid  dark:border-sky-200 rounded-l-xl flex-col gap-5 3xs:gap-10  bg-slate-200 w-[250px] xl:w-[300px] pr-4 pl-4 pt-4">
